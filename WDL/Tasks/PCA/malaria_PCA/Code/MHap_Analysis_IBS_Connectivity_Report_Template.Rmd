...
```{r, fig.width=8, fig.height=7, fig.cap="**Figure 1:** Principal Component analysis (PCA) based on the IBS. Colors are randomly assigned based on the categories of Variable1. Each dot represents a sample."}
IBS_PCA
```
