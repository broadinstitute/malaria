---
title: "*MHap Analysis Report*: PCA of Genetic Relatedness (IBS)"
author: "Neafsey Lab"
output:
  html_document:
    toc: yes
...
```{r, fig.width=6, fig.height=4.5, fig.cap="**Figure 1:** Principal Component analysis (PCA) based on the IBS. Colors are randomly assigned based on the categories of Variable1. Each dot represents a sample."}
IBS_PCA
```
